    ...
    <Header
      ...
      <div className="banner">
        <div className="ban position-relative p-4 h-100 d-flex justify-content-center">
          <p className="fw-bold fs-3"style={{ color: "#2c592c"  }} >CONOCENOS</p>
        </div>
      </div>
        <div className="container">
          <p className="texo text-center position-relative p-2  aling-items-center " style={{ color: "#616161"  }}>Somos aprendices de el tecnólogo de Producción en Contenidos Multimedia del Servicio Nacional de Aprendizaje (SENA), desarrollamos 
        ...
        <div className="row">
          <div className="col ">
            <div className="card m-auto  border-white" style={{ width: "25rem"}}>
              <img className="img4 ml-auto p-2" width="320" height="360" src="./Valentina.jpeg" alt="" />
            ...
            <div className=" m-auto  border-white d-flex" style={{ width: "23rem"}}>
              ...
              <div className="card-body d-flex flex-column justify-content-center">
                <p className="card-text d-flex text-start" style={{ color: "#616161"  }}>valen_ateho</p>
                <p className="card-text d-flex text-start" style={{ color: "#616161"  }}>+57 311 2896155</p>
                <p className="card-text d-flex text-start" style={{ color: "#616161"  }}>vatehortua228@gmail.com</p>
              </div>
            </div>
          </div>
          </div>
          <div className="col">
            <div className="card m-auto  border-white" style={{ width: "23rem"}}>
              <img className="img4 m-auto p-2" width="320" height="360" src="./Nicol.jpeg" alt="" />
              <div className="card-body">
            ...
            <div className=" m-auto  border-white d-flex" style={{ width: "23rem"}}>
              <img className="img4 m-auto" width="50" src="./redess.gif" alt="" />
              <div className="card-body d-flex flex-column justify-content-center">
                <p className="card-text d-flex justify-content-center" style={{ color: "#616161"  }}>bourbaki_twenty_one_pilots</p>
                <p className="card-text d-flex justify-content-center" style={{ color: "#616161"  }}>+57 320 7406079</p>
                <p className="card-text d-flex justify-content-center" style={{ color: "#616161"  }}>nicolmaderamc123@gmail.com</p>
              </div>
            </div>
          </div>
          </div>
          <div className="col">
            <div className="card m-auto  border-white" style={{ width: "23rem"}}>
              <img className="img4 ms-auto p-2" width="335" src="./Keren.jpeg" alt="" />
              <div className="card-body">
            ...
            <div className=" m-auto  border-white d-flex" style={{ width: "23rem"}}>
              ...
              <div className="h  justify-content-center d-flex flex-column">
                <p className="card-text text-end" style={{ color: "#616161"  }}>Linsy_cb</p>
                <p className="card-text text-end" style={{ color: "#616161"  }}>+57 311 3446262</p>
                <p className="card-text text-end" style={{ color: "#616161"  }}>kerencaldera16@gmail.com</p>
              </div>
