        ...
        <div className="container border-none">
            <div className="card text-center border-0">
                ...
                <div className="row d-flex justify-content-center align-items-start mt-4 mb-4">
                    ...
                    <div className="col-8 col-lg-4 mb-3 fade-in-scroll" style={{ transitionDelay: "0.1s" }}>
                        <div style={headerStyle}>
                            <h5 style={{ color: "#5d9a64", textAlign: "left", margin: 0, flex: 1 }}>Primer Objetivo Específico</h5>
                        </div>
                        <p style={{ color: "#868686", textAlign: "left", margin: 0 }}>
                    ...
                    <div className="col-8 col-lg-4 mb-3 fade-in-scroll" style={{ transitionDelay: "0.3s" }}>
                        <div style={headerStyle}>
                            <h5 style={{ color: "#5d9a64", textAlign: "center", margin: 0, flex: 1 }}>Segundo Objetivo Específico</h5>
                        </div>
                        <p style={{ color: "#868686", textAlign: "center", margin: 0 }}>
                    ...
                    <div className="col-8 col-lg-4 mb-3 fade-in-scroll" style={{ transitionDelay: "0.5s" }}>
                        <div style={headerStyle}>
                            <h5 style={{ color: "#5d9a64", textAlign: "right", margin: 0, flex: 1 }}>Tercer Objetivo Específico</h5>
                        </div>
                        <p style={{ color: "#868686", textAlign: "right", margin: 0 }}>
