    ...
    return(
        <div className={` ${fondob}`} style={{minHeight: "200px"}}>
            <div className=" container text-center pb-2">
                ...
                <button 
                    type="button" 
                    className="btn btn-lg px-5 py-3 fw-bold mt-4"
